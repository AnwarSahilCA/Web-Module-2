...
players.filter(function (player) {
    if (player.total_runs > 4000)
        console.log(player.name, player.total_runs);
});
//3.map- create new 
// var newScores=scores.map(function(score){ //not a suggested
//     return(score*2);
// });
...
// var newScores=scores.map(
// (score)=>{
//     return (score*2);
// });
// console.log(newScores)
var sortedScores = scores.sort(function (score1, score2) {
    if (score1 > score2) {
        return 1;
    } //here -1 descendin order, 1 ascending order
    else {
        return -1;
    }
});
console.log(sortedScores);
var sortTotalScores = players.sort(function (player1, player2) {
